...
def parse_commands(string: str) -> tuple[int, int]:
...
def display_crt(crt_screen: list) -> str:
    ...
    for cycle_number in range(0, 241):
        ...
        if cycle == 0:
            ...
            try:
                ...
                cycle, increment = (1, 0)  # Inject noop
        drawing_position = (
            drawing_position[0], drawing_position[1] + 1)

    print(f"sum of cycle values: {sum(cycle_values)}")
    print(display_crt(crt_screen))
